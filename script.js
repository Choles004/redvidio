 ...
 *
 * Se ha modificado el prompt para que no imponga restricciones en la fecha; es decir,
 * se permite crear una tarea para hoy, mañana o cualquier otra fecha.
 */
...
- nombre (string)
- descripcion (string)
- fecha (YYYY-MM-DD) (puede ser hoy, mañana o cualquier otra fecha sin restricción)
- dificultad (easy, medium o hard)
Responde SOLO con el JSON sin texto adicional.
  `;
